...
rule spikein_unitas:
    input:
        get_spikein_fasta()
    params:
        script = workflow.source_path('scripts/spikein_unitas.py')
    output:
...
rule unitas_annotation2yaml:
    ...
    params:
        script = workflow.source_path('scripts/unitas_annotation2json.py')
    output:
...
rule unitas_mirtable:
    ...
    params:
        script = workflow.source_path('scripts/unitas_mirtable.py')
    output:
...
rule unitas_isomirtable:
    ...
    params:
        script = workflow.source_path('scripts/unitas_isomirtable.py'),
        min_count = 0
    output:
...
rule unitas_trftable:
    ...
    params:
        script = workflow.source_path('scripts/unitas_trftable.py')
    output:
...
rule unitas_isotrftable:
    ...
    params:
        script = workflow.source_path('scripts/unitas_isotrftable.py')
    output:
...
rule unitas_allhits:
    ...
    params:
        script = workflow.source_path('scripts/unitas_allhits.py') 
    output:
...
rule unitas_modifications:
    ...
    params:
        script = workflow.source_path('scripts/unitas_modifications.py'),
...
rule unitas_annotations:
    ...
    params:
        script = workflow.source_path('scripts/unitas_annotations.py')
    output:
...
rule unitas_allfeatures:
    ...
    params:
        script = workflow.source_path('scripts/unitas_feature_counts.py') 
    output:
...
rule unitas_isomir_tximport:
    ...
    params:
        script = workflow.source_path('scripts/isomir2tximport.R')
    shell:
...
rule unitas_mirna_anndata:
    ...
    params:
        script = workflow.source_path('scripts/create_anndata.py')
    container:
