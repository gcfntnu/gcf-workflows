...
rule salmon_tximport:
    ...
    params:
        script = workflow.source_path('scripts/tximport.R')
    container:
...
rule salmon_tximeta:
    ...
    params:
        script = workflow.source_path('scripts/tximeta.R'),
...
rule terminus_tx2terminus:
    ...
    params:
        script = workflow.source_path('scripts/extract_txp_group.py')
    threads:
        16
    shell:
...
rule terminus_info:
    ...
    params:
        script = workflow.source_path('scripts/terminus_anno.py')
    output:
